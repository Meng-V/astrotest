...
import MUL_red_white from "../assets/logo/MUL_red_white.png";
import MUL_red_black from "../assets/logo/MUL_red_black.png";
import {
  ResearchMenu,
  UseLibraryMenu,
  AboutMenu,
